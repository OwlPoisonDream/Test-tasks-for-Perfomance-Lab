...
print("Я не особо понимаю тему с json ом и прочим, поэтому делал с оглядкой на готовое решение.")
class ParseJSON:
	...
	def main_parse(self):
		...
		with open(f'{os.getcwd()}/report.json', 'w') as f: #Создаёт файл в той же папке, где и файл питона
			f.write(report_json)
		return
...
if __name__ == '__main__':
	tests = input('Путь до файла tests.json с указанием самого файла: ')
	values = input('Путь до файла values.json с указанием самого файла: ')
